...
import ClassesPackage.Recipe;
import InterfacePackage.PrintRecipeResource;
...
public class RecipeConsumption extends JFrame implements ActionListener{

    private LinkedList<JButton> b;
    private LinkedList<Recipe> res;
    public RecipeConsumption() {
        super("les recettes");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        for(int i=0; i< res.size(); i++)
        {
            ...
            {
                new RecipeConsumptionDisplay(res.get(i));
            }
        }
    }
