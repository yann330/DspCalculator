...
public class PrintRecipeDisplay extends JFrame{
        public PrintRecipeDisplay(Recipe r){
            ...
            time.setBounds(0,y=y+20, 400, 30 );
            // Producers
            JLabel prod_title = new JLabel();
            prod_title.setText("<html><h2><em>Producers:</em></h2><html>");
            prod_title.setBounds(0, y=y+20, 400, 30);
            JLabel[] producers = new JLabel[r.getProducers().size()];
            // In
            JLabel in_title = new JLabel();
            in_title.setText("<html><h2><em>In:</em></h2><html>");
            JLabel[] in = new JLabel[r.getIn().size()];
            y=80;
            // Out
            JLabel out_title = new JLabel();
            out_title.setText("<html><h2><em>Out:</em></h2><html>");
            ...
            in_title.setBounds(0, y=y+20, 400, 30);
            // IN
